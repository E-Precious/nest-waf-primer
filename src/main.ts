...
//We need to synthesize the directory path which will contain templates
...
async function bootstrap() {
  ...
  const app = await NestFactory.create<NestExpressApplication>(
    ...
    /* We also need to get directory name views (create it in project root directory), which is the root directory forour template files */
    const views = join(__dirname,'..', 'views');
    
    /*Finally, configure nunjucks, settings views and express declared above*/
